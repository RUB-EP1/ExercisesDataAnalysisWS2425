...
f_prime = Zygote.gradient(f, x0)

# ╔═╡ 4d38b663-989c-4592-926c-2dbb64e6de7e
y, back_y = Zygote.pullback(f, 5.0)

# ╔═╡ 5fbb7ade-6f86-47b2-afbd-8a8fd8d57836
back_y(1.0)
...
# ╔═╡ 268d6c5a-2ab0-4af1-bccf-b8ae533e29cd
y0 = 4.0

# ╔═╡ 268eece5-db11-41f9-a004-605fd017dbe4
z, back_z = Zygote.pullback(g, x0, y0)

# ╔═╡ e5e52f74-7a6d-4014-9b8e-b818fc83dbc3
...
# ╔═╡ 1eda1f40-aaa4-4bd8-a33d-4c5b17c6e74c
q0 = [x0, y0]

# ╔═╡ b6d99671-6d26-4471-817b-d09f18878935
t, back_h = Zygote.pullback(h, q0)

# ╔═╡ 1e0a45fa-8300-4ba5-b82f-905b13ba4f4d
back_h(1) # one argument, a vector
...
manifest_format = "2.0"
project_hash = "5d1a5917822beafb83c6a679f4f077d2ffb34ce1"
