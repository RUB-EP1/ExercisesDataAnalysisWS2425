...
md"""
# Lecture 10a: Boosted Decision Trees
...
# ╔═╡ 6134ffc1-8587-4826-8726-152a7f6878af
...
# ╔═╡ 1c970b05-83df-45be-b1ee-1bd811e70d38
md"""
## Train and test
"""
...
df_test = subset(df_split, :usage => ByRow(isequal(:test)));

# ╔═╡ 0ccff4af-1306-472b-b2d8-4a4beee1eeba
df_train = subset(df_split, :usage => ByRow(isequal(:test)));
...
# ╔═╡ bd74da9e-7507-4b4b-b703-c11f371188ed
md"""
There are two methods that makes DT more powerful
 - Bagging (Bootstrap aggregating)
 - Boosting
"""

# ╔═╡ 7217d650-5363-4892-b5b9-f2f4d60c4172
md"""
## Optimization 1: Random Forest
"""
...
md"""
## Optimization 2: Adaptive Boosting
"""
...
manifest_format = "2.0"
project_hash = "e68b8e1234910910d26371bcc66cfe460b1f3746"
