...
# ╔═╡ 253370e3-5f5d-41bd-9ac8-317db04b8a2b
yv = randn(1000);

# ╔═╡ d20a1e7c-681d-49c2-b635-6cecccbaaaba
M0 = hcat(xv, yv)
...
# ╔═╡ d0401043-befc-4a10-96d9-0253505c16be
Markdown.parse("#### Correlation is $(round(100*ρ0, digits=2))%")

# ╔═╡ 22105555-f607-48fd-9cb6-1cb431b25397
md"""
## Modified set
"""
...
manifest_format = "2.0"
project_hash = "2e6f5077c6f48cb898ea876176b8a25307150e59"
